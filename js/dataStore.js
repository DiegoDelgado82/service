async function getStore() {
  ...
  async function datosTienda(nro) {
    ...
    if (tiendas.Nro===nro)
        {
            ...
            alert("Nro tienda: "+ tiendas.Nro + " Nombre: "+tiendas.Nombre+ " Direccion: " + tiendas.Direccion + " Telefono: "+tiendas.Telefono)  
            xIndex++;
        }
    ...
    document.getElementById("datostienda").innerHTML =leyenda+ "</ul><br><br><br><br><h4>Datos de la tienda</h4>"
    ...
    if (Number(tiendas.Nro)===nro)
        {
            ...
            "</li><li>Provincia: "+ tiendas.Provincia+"</li><li>Telefono: "+tiendas.Telefono +"</li><li>Líder de Tienda: "+tiendas.Lider+" </li> </ul>";
